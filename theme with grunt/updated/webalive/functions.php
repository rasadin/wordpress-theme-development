...
function webalive_public_scripts() {
	...
	wp_enqueue_style( 'webalive', get_template_directory_uri() . '/assets/dist/css/theme.min.css' );

	wp_enqueue_script( 'webalive-libs', get_template_directory_uri() . '/assets/dist/js/libs.min.js', array('jquery'), rand(), true );
	wp_enqueue_script( 'webalive', get_template_directory_uri() . '/assets/dist/js/theme.min.js', array('jquery'), rand(), true );
