...
if( !class_exists( 'Webalive_WooCommerce' ) ) :

    /**
     * The Webalive WooCommerce Integration Class
     */
    class Webalive_WooCommerce {
        ...
        /**
         * Webalive WooCommerce Scripts
         * 
         * @since 1.0.0
         */
        public function woocommerce_scripts() {
		    wp_enqueue_style( 'webalive-woo-style', get_template_directory_uri() . '/woocommerce.css' );  
        }
		...
		public function related_products_args( $args ) {
			$args = apply_filters( 'webalive_related_products_args', array(
				'posts_per_page' => 3,
				'columns'        => 3,
			) );
...
return new Webalive_WooCommerce();